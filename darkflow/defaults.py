class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('dataset', 'test/training/images', 'path to dataset directory')
        ...
        self.define('annotation', 'test/training/annotations', 'path to annotation directory')
        self.define('threshold', -0.1, 'detection threshold')
        self.define('model', '', 'configuration of choice')
        self.define('trainer', 'sgd', 'training algorithm')
